...
export function hello(rc) {
    rc.res.write('Hello World');
    rc.res.end();
}

export function validate(rc) {
    rc.res.write('true');
    rc.res.end();
}
...
export function renderOld(rc) {
    ...
    var req:Express.Request = rc.req;
    var address:string = rc.req.query.url;
    var viewPortHeight:number = +rc.req.query.viewPortHeight || 1024;
    var viewPortWidth:number = +rc.req.query.viewPortWidth || 1280;
    var delay:number = 0;
    //var delay:number = +rc.req.query.delay || 0;
                    ...
                    try {
                        ...
                        var renderWhenReady = function () {
                            try {
                                ...
                                if ((
                                    activityTimeDiff < 300 || renderDuration < 1000 * delay
                                    ) && renderDuration < 1000 * (
                                    delay + graceTime
                                    )) {
